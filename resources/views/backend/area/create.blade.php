    ...
    <section>
        <div class="container-fluid">
            <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-info"><i
                    class="dripicons-plus"></i> {{ trans('file.Add Area') }}</a>
        </div>
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        ...
                                        <li>
                                            <button type="button" data-id="{{ $area->id }}"
                                                class="open-EditAreaDialog btn btn-link" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Type Area Name..." name="name" required="required"
                            class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href="sample_file/sample_warehouse.csv" class="btn btn-info btn-block btn-md"><i
...
@push('scripts')
    <script type="text/javascript">
        ...
        $("ul#people #area-list-menu").addClass("active");
